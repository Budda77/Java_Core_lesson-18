...
public class Coords<T extends TwoC> {
	...
	public static void showXY(Coords<?> c) {
		...
		for (int i = 0; i < c.coords.length; i++) {
			System.out.println(c.coords[i].x + "__" + c.coords[i].y);
			//System.out.println();
		}
	}
		...
		public static void showXYZ(Coords<? extends ThreeC> c) {
			...
			for (int i = 0; i < c.coords.length; i++) {
				System.out.println(c.coords[i].x + "__" + c.coords[i].y + "__" + c.coords[i].z);
				System.out.println();
			}
		}
		...
		public static void showXYZT(Coords<? extends FourC> c) {
			...
			for (int i = 0; i < c.coords.length; i++) {
				System.out.println(c.coords[i].x + "__" + c.coords[i].y + "__" + c.coords[i].z + "__" + c.coords[i].t);
				System.out.println();
			}
		}
		...
		public static void showXYsuper(Coords<? super FourC> c) {
			System.out.println("Coordinates of XYZ :");
			for (int i = 0; i < c.coords.length; i++) {
				System.out.println(c.coords[i].x + "__" + c.coords[i].y + "_" );
				System.out.println();
			}
		}
